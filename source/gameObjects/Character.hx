		...
		switch (curCharacter)
		{
			case 'gf':
				...
				case 'uncanny':
					...
					tex = Paths.getSparrowAtlas('characters/uncanny');
					frames = tex;
					...
					case 'uncanny2':
						// DAD ANIMATION LOADING CODE
						tex = Paths.getSparrowAtlas('characters/not so canny incredible');
						frames = tex;
						animation.addByPrefix('idle', 'idle', 24);
						animation.addByPrefix('singUP', 'up', 24);
						animation.addByPrefix('singRIGHT', 'right', 24);
					...
					case 'uncanny3':
						// DAD ANIMATION LOADING CODE
						tex = Paths.getSparrowAtlas('characters/uncanny3');
						frames = tex;
						animation.addByPrefix('idle', 'idle', 24);
						animation.addByPrefix('singUP', 'up', 24);
						animation.addByPrefix('singRIGHT', 'right', 24);
			...
			case 'bf':
				...
				case 'uncanny-phantasm':
					frames = Paths.getSparrowAtlas('characters/uncanny_saddened');
